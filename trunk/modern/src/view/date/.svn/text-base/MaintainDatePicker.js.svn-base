 ...
 *
 */
Ext.define('hdts.view.date.MaintainDatePickerField', {
    extend: 'Ext.field.Picker',
    alternateClassName: 'Ext.form.MaintainDatePickerField',
    xtype: 'maintaindatepickerfield',

    requires: [
        //'Ext.field.trigger.Date',
        'hdts.view.date.MaintainDatePicker'
    ],
    ...
    getPicker: function() {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, hdts.view.date.MaintainDatePicker);
            if (value !== null) {
